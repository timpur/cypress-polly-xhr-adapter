...
function () {
  ...
  XHRMock.prototype.mock = function (fnOrMethod, url, mock) {
    ...
    if (typeof fnOrMethod === 'string' && (typeof url === 'string' || url instanceof RegExp) && mock !== undefined) {
...
exports.XHRMock = XHRMock; // I'm only using a class so I can make use make use of TS' method overrides
